<?php
        ...
        $productId = 423; // 🔁 Change this per product page
        ...
        $initialStock = $variants[54]['stock_quantity'] ?? 50;
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/outfoxed.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/outfoxed.PNG" checked hidden>
                                    <img src="img/products/outfoxed.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/fox2.jpg" hidden>
                                    <img src="img/products/fox2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/fox3.jpg" hidden>
                                    <img src="img/products/fox3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn option-btn active" 
                                            data-price="499" 
                                            data-variant-id="54" 
                                            data-stock="<?php echo $variants[54]['stock_quantity'] ?? 0; ?>">
                                        Standard
                                    </button>
                        ...
                        <div class="action-buttons mt-4">
                            <button type="button" class="btn-action btn-add">Add to Cart</button>
                            <button type="button" class="btn-action btn-buy" onclick="handleAction('buy')">Buy Now</button>
                        </div>
                    </div>
                </div>
                <!--PRODUCT INFO -->
        ...
        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
            ...
            <input type="hidden" id="variant_id" name="variant_id" value="54">

<?php
        ...
        $productId = 444; // 🔁 Change this per product page
        ...
        $initialStock = $variants[91]['stock_quantity'] ?? 70;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/gear3.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gear3.jpg" checked hidden>
                                    <img src="img/products/gear3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gear2.jpg" hidden>
                                    <img src="img/products/gear2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gearr.jpg" hidden>
                                    <img src="img/products/gearr.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                            <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // Fetch stock for Variant 91
                                        $stock91 = $variants[91]['stock_quantity'] ?? 0;
                                        $is91Disabled = ($stock91 <= 0);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo !$is91Disabled ? 'active' : 'disabled-variant'; ?>" 
                                            data-price="149" 
                                            data-variant-id="91" 
                                            data-stock="<?php echo $stock91; ?>"
                                            <?php echo $is91Disabled ? 'disabled' : ''; ?>>
                                        Standard <?php echo $is91Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="custom-qty-wrapper">
                                        ...
                                        <input
                                            type="text"
                                            id="qty"
                                            value="<?php echo $is91Disabled ? '0' : '1'; ?>"
                                            readonly
                                            inputmode="numeric"
                                    ...
                                    <span class="text-muted">
                                        Stock: <strong id="stockCount"><?php echo $stock91; ?></strong>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="action-buttons mt-4">
                                <button type="button" id="addToCartBtn" class="btn-action btn-add"
                                        <?php echo $is91Disabled ? 'disabled style="background: gray; cursor: not-allowed;"' : ''; ?>>
                                    Add to Cart
                                </button>
                                <button type="button" id="buyNowBtn" class="btn-action btn-buy" onclick="handleAction('buy')"
                                        <?php echo $is91Disabled ? 'disabled style="background: #ccc; cursor: not-allowed;"' : ''; ?>>
                                    Buy Now
                                </button>
                            </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="91">
                                <input type="hidden" id="formQty" name="quantity" value="<?php echo $is91Disabled ? '0' : '1'; ?>">
                            </form>
                    </div>
                </div>
                <!--PRODUCT INFO -->

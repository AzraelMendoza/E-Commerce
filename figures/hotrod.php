<?php
        ...
        $productId = 412; // 🔁 Change this per product page
        ...
        $initialStock = $variants[25]['stock_quantity'] ?? 52;
...
<body>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/hot1.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                <div class="d-flex justify-content-center gap-3 mt-3">
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/hot1.jpg" checked hidden>
                                        <img src="img/products/hot1.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/hot2.jpg" hidden>
                                        <img src="img/products/hot2.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/hot3.jpg" hidden>
                                        <img src="img/products/hot3.jpg" class="thumb">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 25 and 26
                                            $stock25 = $variants[25]['stock_quantity'] ?? 0;
                                            $is25Disabled = ($stock25 <= 0);

                                            $stock26 = $variants[26]['stock_quantity'] ?? 0;
                                            $is26Disabled = ($stock26 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 26) ? $stock26 : $stock25;
                                            $allOutOfStock = ($is25Disabled && $is26Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 25) ? 'active' : ''; ?> <?php echo $is25Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1099" 
                                                data-variant-id="25" 
                                                data-stock="<?php echo $stock25; ?>"
                                                <?php echo $is25Disabled ? 'disabled' : ''; ?>>
                                            Without Accessories <?php echo $is25Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 26) ? 'active' : ''; ?> <?php echo $is26Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1199" 
                                                data-variant-id="26" 
                                                data-stock="<?php echo $stock26; ?>"
                                                <?php echo $is26Disabled ? 'disabled' : ''; ?>>
                                            With Accessories <?php echo $is26Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 25; ?>">
            ...
            <div class="container mb-5">
                ...
                <form id="cartForm" style="display:none;">
                    <input type="hidden" id="product_id" value="412">
                    <input type="hidden" id="variant_id" value="25">
                    <input type="hidden" id="formQty" value="1">
                </form>

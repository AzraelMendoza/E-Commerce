<?php
        ...
        $productId = 431; // 🔁 Change this per product page
        ...
        $initialStock = $variants[70]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/DayanM.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/DayanM.PNG" checked hidden>
                                    <img src="img/products/DayanM.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/dayanm2.jpg" hidden>
                                    <img src="img/products/dayanm2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/dayan3.jpg" hidden>
                                    <img src="img/products/dayan3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // Fetch stock for variants 70 and 71
                                        $stock70 = $variants[70]['stock_quantity'] ?? 0;
                                        $is70Disabled = ($stock70 <= 0);

                                        $stock71 = $variants[71]['stock_quantity'] ?? 0;
                                        $is71Disabled = ($stock71 <= 0);
                                        ...
                                        $initialStock = ($defaultActiveId == 71) ? $stock71 : $stock70;
                                        $allOutOfStock = ($is70Disabled && $is71Disabled);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 70) ? 'active' : ''; ?> <?php echo $is70Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1199" 
                                            data-variant-id="70" 
                                            data-stock="<?php echo $stock70; ?>"
                                            <?php echo $is70Disabled ? 'disabled' : ''; ?>>
                                        Magnetic <?php echo $is70Disabled ? '(Sold Out)' : ''; ?>
                                    </button>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 71) ? 'active' : ''; ?> <?php echo $is71Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1399" 
                                            data-variant-id="71" 
                                            data-stock="<?php echo $stock71; ?>"
                                            <?php echo $is71Disabled ? 'disabled' : ''; ?>>
                                        Maglev <?php echo $is71Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 70; ?>">

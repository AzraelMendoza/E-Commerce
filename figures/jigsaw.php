<?php
        ...
        $productId = 442; // 🔁 Change this per product page
        ...
        $initialStock = $variants[88]['stock_quantity'] ?? 40;
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Jigsaw.avif" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Jigsaw.avif" checked hidden>
                                    <img src="img/products/Jigsaw.avif" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/jigsaw1.jpg" hidden>
                                    <img src="img/products/jigsaw1.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/jigsaw2.jpg" hidden>
                                    <img src="img/products/jigsaw2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variant 88
                                                $stock88 = $variants[88]['stock_quantity'] ?? 0;
                                                $is88Disabled = ($stock88 <= 0);

                                                // 2. Set initial values for the page display
                                                $initialStock = $stock88;
                                                $allOutOfStock = $is88Disabled;
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo !$is88Disabled ? 'active' : 'disabled-variant'; ?>" 
                                                    data-price="1999" 
                                                    data-variant-id="88" 
                                                    data-stock="<?php echo $stock88; ?>"
                                                    <?php echo $is88Disabled ? 'disabled' : ''; ?>>
                                                Standard <?php echo $is88Disabled ? '(Sold Out)' : ''; ?>
                                            </button> 
                                        </div>
                                    </div>
                                    ...
                                    <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                        ...
                                        <input type="hidden" id="variant_id" name="variant_id" value="88">
        ...
        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
            <input type="hidden" id="product_id" name="product_id" value="<?php echo $productId; ?>">
            <input type="hidden" id="variant_id" name="variant_id" value="87">

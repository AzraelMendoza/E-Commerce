  <?php
        ...
        $productId = 447; // 🔁 Change this per product page
        ...
        $initialStock = $variants[98]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/sirius.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/sirius.PNG" checked hidden>
                                    <img src="img/products/sirius.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/sir2.jpg" hidden>
                                    <img src="img/products/sir2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/sir3.jpg" hidden>
                                    <img src="img/products/sir3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                 <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 98, 99, and 100
                                            $stock98 = $variants[98]['stock_quantity'] ?? 0;
                                            $is98Disabled = ($stock98 <= 0);

                                            $stock99 = $variants[99]['stock_quantity'] ?? 0;
                                            $is99Disabled = ($stock99 <= 0);

                                            $stock100 = $variants[100]['stock_quantity'] ?? 0;
                                            $is100Disabled = ($stock100 <= 0);
                                            ...
                                            if (!$is98Disabled) {
                                                ...
                                                $defaultActiveId = 99;
                                            } elseif (!$is100Disabled) {
                                                $defaultActiveId = 100;
                                            }

                                            // 3. Set initial stock value based on selection
                                            if ($defaultActiveId == 98) $initialStock = $stock98;
                                            elseif ($defaultActiveId == 99) $initialStock = $stock99;
                                            elseif ($defaultActiveId == 100) $initialStock = $stock100;
                                            else $initialStock = 0;

                                            $allOutOfStock = ($is98Disabled && $is99Disabled && $is100Disabled);
                                            $flatPrice = "1349";
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 98) ? 'active' : ''; ?> <?php echo $is98Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="98" 
                                                data-stock="<?php echo $stock98; ?>"
                                                <?php echo $is98Disabled ? 'disabled' : ''; ?>>
                                            Yellow Blue <?php echo $is98Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 99) ? 'active' : ''; ?> <?php echo $is99Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="99" 
                                                data-stock="<?php echo $stock99; ?>"
                                                <?php echo $is99Disabled ? 'disabled' : ''; ?>>
                                            Yellow Orange <?php echo $is99Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 100) ? 'active' : ''; ?> <?php echo $is100Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="100" 
                                                data-stock="<?php echo $stock100; ?>"
                                                <?php echo $is100Disabled ? 'disabled' : ''; ?>>
                                            Red <?php echo $is100Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>

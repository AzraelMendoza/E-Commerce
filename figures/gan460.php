<?php
        ...
        $productId = 430; // 🔁 Change this per product page
        ...
        $initialStock = $variants[68]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/gan460v2.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gan460v2.jpg" checked hidden>
                                    <img src="img/products/gan460v2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gan4601.jpg" hidden>
                                    <img src="img/products/gan4601.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gan4602.jpg" hidden>
                                    <img src="img/products/gan4602.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // Fetch stock for variants 68 and 69
                                            $stock68 = $variants[68]['stock_quantity'] ?? 0;
                                            $is68Disabled = ($stock68 <= 0);

                                            $stock69 = $variants[69]['stock_quantity'] ?? 0;
                                            $is69Disabled = ($stock69 <= 0);

                                            // Logic: Auto-select the first available variant on load
                                            ...
                                            $initialStock = ($defaultActiveId == 69) ? $stock69 : $stock68;
                                            $allOutOfStock = ($is68Disabled && $is69Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 68) ? 'active' : ''; ?> <?php echo $is68Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1899" 
                                                data-variant-id="68" 
                                                data-stock="<?php echo $stock68; ?>"
                                                <?php echo $is68Disabled ? 'disabled' : ''; ?>>
                                            Frosted <?php echo $is68Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 69) ? 'active' : ''; ?> <?php echo $is69Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="2199" 
                                                data-variant-id="69" 
                                                data-stock="<?php echo $stock69; ?>"
                                                <?php echo $is69Disabled ? 'disabled' : ''; ?>>
                                            UV Coated <?php echo $is69Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 68; ?>">

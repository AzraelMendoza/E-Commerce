<?php
        ...
        $productId = 443; // 🔁 Change this per product page
        ...
        $initialStock = $variants[89]['stock_quantity'] ?? 30;
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/meilong3.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/meilong3.jpg" checked hidden>
                                    <img src="img/products/meilong3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/meilong1.jpg" hidden>
                                    <img src="img/products/meilong1.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/meilong2.jpg" hidden>
                                    <img src="img/products/meilong2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 89 and 90
                                            $stock89 = $variants[89]['stock_quantity'] ?? 0;
                                            $is89Disabled = ($stock89 <= 0);

                                            $stock90 = $variants[90]['stock_quantity'] ?? 0;
                                            $is90Disabled = ($stock90 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 90) ? $stock90 : $stock89;
                                            $allOutOfStock = ($is89Disabled && $is90Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 89) ? 'active' : ''; ?> <?php echo $is89Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="199" 
                                                data-variant-id="89" 
                                                data-stock="<?php echo $stock89; ?>"
                                                <?php echo $is89Disabled ? 'disabled' : ''; ?>>
                                            Stickerless <?php echo $is89Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 90) ? 'active' : ''; ?> <?php echo $is90Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="239" 
                                                data-variant-id="90" 
                                                data-stock="<?php echo $stock90; ?>"
                                                <?php echo $is90Disabled ? 'disabled' : ''; ?>>
                                            Stickered <?php echo $is90Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 89; ?>">
        ...
        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
            <input type="hidden" id="product_id" name="product_id" value="<?php echo $productId; ?>">
            <input type="hidden" id="variant_id" name="variant_id" value="89">

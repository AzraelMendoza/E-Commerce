  <?php
        ...
        $productId = 449; // 🔁 Change this per product page
        ...
        $initialStock = $variants[114]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/bull2.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/bull2.jpg" checked hidden>
                                    <img src="img/products/bull2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/bull3.jpg" hidden>
                                    <img src="img/products/bull3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/bull4.jpg" hidden>
                                    <img src="img/products/bull4.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for the single variant 114
                                            $stock114 = $variants[114]['stock_quantity'] ?? 0;
                                            $is114Disabled = ($stock114 <= 0);

                                            // 2. Set values for display
                                            $initialStock = $stock114;
                                            $allOutOfStock = $is114Disabled;
                                            $flatPrice = "1499";
                                            $defaultActiveId = 114;
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn active <?php echo $is114Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="114" 
                                                data-stock="<?php echo $stock114; ?>"
                                                <?php echo $is114Disabled ? 'disabled' : ''; ?>>
                                            Standard Color <?php echo $is114Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>

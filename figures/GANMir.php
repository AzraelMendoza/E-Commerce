<?php
        ...
        $productId = 439; // 🔁 Change this per product page
        ...
        $initialStock = $variants[83]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/ganmir.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/ganmir.jpg" checked hidden>
                                    <img src="img/products/ganmir.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/ganMir2.jpg" hidden>
                                    <img src="img/products/ganMir2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/GANMir3.jpg" hidden>
                                    <img src="img/products/GANMir3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex gap-2">
                                                <?php 
                                                    // 1. Fetch stock for variants 83 and 84
                                                    $stock83 = $variants[83]['stock_quantity'] ?? 0;
                                                    $is83Disabled = ($stock83 <= 0);

                                                    $stock84 = $variants[84]['stock_quantity'] ?? 0;
                                                    $is84Disabled = ($stock84 <= 0);
                                                    ...
                                                    $initialStock = ($defaultActiveId == 84) ? $stock84 : $stock83;
                                                    $allOutOfStock = ($is83Disabled && $is84Disabled);
                                                ?>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo ($defaultActiveId == 83) ? 'active' : ''; ?> <?php echo $is83Disabled ? 'disabled-variant' : ''; ?>" 
                                                        data-price="1449" 
                                                        data-variant-id="83" 
                                                        data-stock="<?php echo $stock83; ?>"
                                                        <?php echo $is83Disabled ? 'disabled' : ''; ?>>
                                                    Bright Violet <?php echo $is83Disabled ? '(Sold Out)' : ''; ?>
                                                </button>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo ($defaultActiveId == 84) ? 'active' : ''; ?> <?php echo $is84Disabled ? 'disabled-variant' : ''; ?>" 
                                                        data-price="1449" 
                                                        data-variant-id="84" 
                                                        data-stock="<?php echo $stock84; ?>"
                                                        <?php echo $is84Disabled ? 'disabled' : ''; ?>>
                                                    Bright Fuchsia <?php echo $is84Disabled ? '(Sold Out)' : ''; ?>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                            ...
                                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 83; ?>">

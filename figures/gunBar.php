<?php
        ...
        $productId = 409; // 🔁 Change this per product page
        ...
        $initialStock = $variants[19]['stock_quantity'] ?? 25;
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/gundamBarb1.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                <div class="d-flex justify-content-center gap-3 mt-3">
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/gundamBarb1.PNG" checked hidden>
                                        <img src="img/products/gundamBarb1.PNG" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/gb1.PNG" hidden>
                                        <img src="img/products/gb1.PNG" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/gb2.PNG" hidden>
                                        <img src="img/products/gb2.PNG" class="thumb">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // Fetch stock levels
                                            $stock19 = $variants[19]['stock_quantity'] ?? 0;
                                            $is19Disabled = ($stock19 <= 0);

                                            $stock20 = $variants[20]['stock_quantity'] ?? 0;
                                            $is20Disabled = ($stock20 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 20) ? $stock20 : $stock19;
                                            $allOutOfStock = ($is19Disabled && $is20Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 19) ? 'active' : ''; ?> <?php echo $is19Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1249" 
                                                data-variant-id="19" 
                                                data-stock="<?php echo $stock19; ?>"
                                                <?php echo $is19Disabled ? 'disabled' : ''; ?>>
                                            Without Accessories <?php echo $is19Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 20) ? 'active' : ''; ?> <?php echo $is20Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1349" 
                                                data-variant-id="20" 
                                                data-stock="<?php echo $stock20; ?>"
                                                <?php echo $is20Disabled ? 'disabled' : ''; ?>>
                                            With Accessories <?php echo $is20Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 19; ?>">

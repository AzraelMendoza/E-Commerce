<?php
        ...
        $productId = 402; // 🔁 Change this per product page
    ...
    /* ===============================
        ...
        $initialStock = $variants[5]['stock_quantity'] ?? 50;
                ...
                <div class="row g-5">
                            ...
                            <div class="col-lg-5">
                                <div class="sticky-top" style="top: 100px;">
                                    <img id="mainImage" src="img/products/gundamWing.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                    <div class="d-flex justify-content-center gap-3 mt-3">
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/gundamWing.PNG" checked hidden>
                                            <img src="img/products/gundamWing.PNG" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/gw2.jpg" hidden>
                                            <img src="img/products/gw2.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/gw3.jpg" hidden>
                                            <img src="img/products/gw3.jpg" class="thumb">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7 ps-lg-5">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex gap-2">
                                                <?php 
                                                    // 1. Fetch stock for variants 5 and 6
                                                    $stock5 = $variants[5]['stock_quantity'] ?? 0;
                                                    $is5Disabled = ($stock5 <= 0);

                                                    $stock6 = $variants[6]['stock_quantity'] ?? 0;
                                                    $is6Disabled = ($stock6 <= 0);
                                                    ...
                                                    $initialStock = ($defaultActiveId == 6) ? $stock6 : $stock5;
                                                    $allOutOfStock = ($is5Disabled && $is6Disabled);
                                                ?>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo ($defaultActiveId == 5) ? 'active' : ''; ?> <?php echo $is5Disabled ? 'disabled-variant' : ''; ?>" 
                                                        data-price="1299" 
                                                        data-variant-id="5" 
                                                        data-stock="<?php echo $stock5; ?>"
                                                        <?php echo $is5Disabled ? 'disabled' : ''; ?>>
                                                    Without Accessories <?php echo $is5Disabled ? '(Sold Out)' : ''; ?>
                                                </button>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo ($defaultActiveId == 6) ? 'active' : ''; ?> <?php echo $is6Disabled ? 'disabled-variant' : ''; ?>" 
                                                        data-price="1399" 
                                                        data-variant-id="6" 
                                                        data-stock="<?php echo $stock6; ?>"
                                                        <?php echo $is6Disabled ? 'disabled' : ''; ?>>
                                                    With Accessories <?php echo $is6Disabled ? '(Sold Out)' : ''; ?>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                            ...
                                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 5; ?>">

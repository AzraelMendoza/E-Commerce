<?php
        ...
        $productId = 445; // 🔁 Change this per product page
        ...
        $initialStock = $variants[92]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/growsland.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/growsland.jpg" checked hidden>
                                    <img src="img/products/growsland.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/grow2.jpg" hidden>
                                    <img src="img/products/grow2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/grow3.jpg" hidden>
                                    <img src="img/products/grow3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            ...
                                            $stock92 = $variants[92]['stock_quantity'] ?? 0;
                                            $is92Disabled = ($stock92 <= 0);

                                            $stock93 = $variants[93]['stock_quantity'] ?? 0;
                                            $is93Disabled = ($stock93 <= 0);

                                            $stock94 = $variants[94]['stock_quantity'] ?? 0;
                                            $is94Disabled = ($stock94 <= 0);
                                            ...
                                            if ($defaultActiveId == 92) $initialStock = $stock92;
                                            elseif ($defaultActiveId == 93) $initialStock = $stock93;
                                            elseif ($defaultActiveId == 94) $initialStock = $stock94;
                                            else $initialStock = 0;

                                            $allOutOfStock = ($is92Disabled && $is93Disabled && $is94Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 92) ? 'active' : ''; ?> <?php echo $is92Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1399" 
                                                data-variant-id="92" 
                                                data-stock="<?php echo $stock92; ?>"
                                                <?php echo $is92Disabled ? 'disabled' : ''; ?>>
                                            Yellow <?php echo $is92Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 93) ? 'active' : ''; ?> <?php echo $is93Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1399" 
                                                data-variant-id="93" 
                                                data-stock="<?php echo $stock93; ?>"
                                                <?php echo $is93Disabled ? 'disabled' : ''; ?>>
                                            Orange <?php echo $is93Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 94) ? 'active' : ''; ?> <?php echo $is94Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1399" 
                                                data-variant-id="94" 
                                                data-stock="<?php echo $stock94; ?>"
                                                <?php echo $is94Disabled ? 'disabled' : ''; ?>>
                                            Red <?php echo $is94Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>

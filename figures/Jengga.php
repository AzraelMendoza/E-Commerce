<?php
        ...
        $productId = 436; // 🔁 Change this per product page
        ...
        $initialStock = $variants[79]['stock_quantity'] ?? 70;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Jengga.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Jengga.jpg" checked hidden>
                                    <img src="img/products/Jengga.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Jengga2.jpg" hidden>
                                    <img src="img/products/Jengga2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Jengga3.jpg" hidden>
                                    <img src="img/products/Jengga3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variant 79
                                            $stock79 = $variants[79]['stock_quantity'] ?? 0;
                                            $is79Disabled = ($stock79 <= 0);

                                            // 2. Set initial values for the page
                                            $initialStock = $stock79;
                                            $allOutOfStock = $is79Disabled;
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo !$is79Disabled ? 'active' : 'disabled-variant'; ?>" 
                                                data-price="449" 
                                                data-variant-id="79" 
                                                data-stock="<?php echo $stock79; ?>"
                                                <?php echo $is79Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is79Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="79">

<?php
        ...
        $productId = 419; // 🔁 Change this per product page
        ...
        $initialStock = $variants[48]['stock_quantity'] ?? 35;
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/monopoly.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/monopoly.jpg" checked hidden>
                                    <img src="img/products/monopoly.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/mono2.jpg" hidden>
                                    <img src="img/products/mono2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/mono3.jpg" hidden>
                                    <img src="img/products/mono3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 48 and 49
                                            $stock48 = $variants[48]['stock_quantity'] ?? 0;
                                            $is48Disabled = ($stock48 <= 0);

                                            $stock49 = $variants[49]['stock_quantity'] ?? 0;
                                            $is49Disabled = ($stock49 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 49) ? $stock49 : $stock48;
                                            $allOutOfStock = ($is48Disabled && $is49Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 48) ? 'active' : ''; ?> <?php echo $is48Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="999" 
                                                data-variant-id="48" 
                                                data-stock="<?php echo $stock48; ?>"
                                                <?php echo $is48Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is48Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 49) ? 'active' : ''; ?> <?php echo $is49Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1099" 
                                                data-variant-id="49" 
                                                data-stock="<?php echo $stock49; ?>"
                                                <?php echo $is49Disabled ? 'disabled' : ''; ?>>
                                            Mega <?php echo $is49Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 48; ?>">
        ...
        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
            <input type="hidden" id="product_id" name="product_id" value="<?php echo $productId; ?>">
            <input type="hidden" id="variant_id" name="variant_id" value="48">

<?php
        ...
        $productId = 429; // 🔁 Change this per product page
        ...
        $initialStock = $variants[65]['stock_quantity'] ?? 40;
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/backgammon.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/backgammon.jpg" checked hidden>
                                    <img src="img/products/backgammon.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/back2.jpg" hidden>
                                    <img src="img/products/back2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/back3.jpg" hidden>
                                    <img src="img/products/back3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <p class="text-secondary" style="font-size: 0.95rem; line-height: 1.6;">
                                ...
                                <div class="mt-4">
                                            ...
                                            <div class="d-flex gap-2">
                                                <?php 
                                                    // 1. Fetch stock for Variant 65
                                                    $stock65 = $variants[65]['stock_quantity'] ?? 0;
                                                    $is65Disabled = ($stock65 <= 0);
                                                ?>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo !$is65Disabled ? 'active' : 'disabled-variant'; ?>" 
                                                        data-price="1199" 
                                                        data-variant-id="65" 
                                                        data-stock="<?php echo $stock65; ?>"
                                                        <?php echo $is65Disabled ? 'disabled' : ''; ?>>
                                                    Standard <?php echo $is65Disabled ? '(Sold Out)' : ''; ?>
                                                </button>
                                            </div>
                                </div>
                                <!-- PRODUCT QUANTITY -->
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="custom-qty-wrapper">
                                            ...
                                            <input type="number" id="qty" 
                                                value="<?php echo $is65Disabled ? '0' : '1'; ?>" 
                                                min="<?php echo $is65Disabled ? '0' : '1'; ?>"> 
                                            <button id="plus" type="button">+</button>
                                        </div>
                                        <span class="text-muted">Stock: <strong id="stockCount"><?php echo $stock65; ?></strong></span>
                                    </div>
                                </div>
                                ...
                                <div class="action-buttons mt-4">
                                    <button type="button" 
                                            ...
                                            id="addToCartBtn"
                                            <?php echo $is65Disabled ? 'disabled style="background: gray; cursor: not-allowed;"' : ''; ?>>
                                        Add to Cart
                                    </button>
                                    <button type="button" 
                                            ...
                                            <?php echo $is65Disabled ? 'disabled style="background: #ccc; cursor: not-allowed;"' : ''; ?>>
                                        Buy Now
                                    </button>
                                </div>
        ...
        <!-- Hidden Cart Form -->
         <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
            ...
            <input type="hidden" id="variant_id" name="variant_id" value="65">
            <input type="hidden" id="formQty" name="quantity" value="<?php echo $is65Disabled ? '0' : '1'; ?>">
        </form>

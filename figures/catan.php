<?php
        ...
        $productId = 427; // 🔁 Change this per product page
        ...
        $initialStock = $variants[63]['stock_quantity'] ?? 35;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/catans.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/catans.jpg" checked hidden>
                                    <img src="img/products/catans.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/catan2.jpg" hidden>
                                    <img src="img/products/catan2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/catan3.jpg" hidden>
                                    <img src="img/products/catan3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // Fetch stock for Variant 63
                                        $stock63 = $variants[63]['stock_quantity'] ?? 0;
                                        $is63Disabled = ($stock63 <= 0);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo !$is63Disabled ? 'active' : 'disabled-variant'; ?>" 
                                            data-price="649" 
                                            data-variant-id="63" 
                                            data-stock="<?php echo $stock63; ?>"
                                            <?php echo $is63Disabled ? 'disabled' : ''; ?>>
                                        Standard <?php echo $is63Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="custom-qty-wrapper">
                                            ...
                                            <input type="number" id="qty" 
                                                value="<?php echo $is63Disabled ? '0' : '1'; ?>" 
                                                min="<?php echo $is63Disabled ? '0' : '1'; ?>"> 
                                            <button id="plus" type="button">+</button>
                                    </div>
                                    <span class="text-muted">Stock: <strong id="stockCount"><?php echo $stock63; ?></strong></span>
                                </div>
                            </div>
                            ...
                            <div class="action-buttons mt-4">
                                <button type="button" id="addToCartBtn" class="btn-action btn-add"
                                        <?php echo $is63Disabled ? 'disabled style="background: gray; cursor: not-allowed;"' : ''; ?>>
                                    Add to Cart
                                </button>
                                <button type="button" id="buyNowBtn" class="btn-action btn-buy" onclick="handleAction('buy')"
                                        <?php echo $is63Disabled ? 'disabled style="background: #ccc; cursor: not-allowed;"' : ''; ?>>
                                    Buy Now
                                </button>
                            </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="63">
                                <input type="hidden" id="formQty" name="quantity" value="<?php echo $is63Disabled ? '0' : '1'; ?>">
                            </form>
                    </div>
                </div>
                <!--PRODUCT INFO -->

<?php
        ...
        $productId = 441; // 🔁 Change this per product page
        ...
        $initialStock = $variants[87]['stock_quantity'] ?? 40;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/yjYupo.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/yjYupo.jpg" checked hidden>
                                    <img src="img/products/yjYupo.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Yupo2.jpg" hidden>
                                    <img src="img/products/Yupo2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Yupo3.jpg" hidden>
                                    <img src="img/products/Yupo3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        $variantStock = $variants[87]['stock_quantity'] ?? 0; 
                                        $isDisabled = ($variantStock <= 0);
                                    ?>
                                    <button type="button" 
                                            class="btn option-btn <?php echo !$isDisabled ? 'active' : 'disabled-variant'; ?>" 
                                            data-price="249" 
                                            data-variant-id="87" 
                                            data-stock="<?php echo $variantStock; ?>"
                                            <?php echo $isDisabled ? 'disabled' : ''; ?>>
                                        Standard <?php echo $isDisabled ? '(Out of Stock)' : ''; ?>
                                    </button>
                                </div>
                    </div>
                        ...
                        <!-- Action Buttons -->
                            <div class="action-buttons mt-4">
                                    <button type="button" 
                                            ...
                                            <?php echo ($initialStock <= 0) ? 'disabled style="background: gray; cursor: not-allowed;"' : ''; ?>>
                                        Add to Cart
                                    </button>
                                    ...
                                    <button type="button" 
                                            ...
                                            <?php echo ($initialStock <= 0) ? 'disabled style="background: #ccc; cursor: not-allowed;"' : ''; ?>>
                                        Buy Now
                                    </button>
                            </div>
                    </div>

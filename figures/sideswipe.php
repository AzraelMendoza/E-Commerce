<?php
        ...
        $productId = 413; // 🔁 Change this per product page
        ...
        $initialStock = $variants[27]['stock_quantity'] ?? 52;
...
<body>
        ...
        <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/sides.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/sides.jpg" checked hidden>
                                    <img src="img/products/sides.jpg" class="thumb">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/sw2.jpg" hidden>
                                    <img src="img/products/sw2.jpg" class="thumb">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/sw3.jpg" hidden>
                                    <img src="img/products/sw3.jpg" class="thumb">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="price" id="price">₱<?php echo htmlspecialchars($product['price']); ?></div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // 1. Fetch stock levels for variants 27 and 28
                                        $stock27 = $variants[27]['stock_quantity'] ?? 0;
                                        $is27Disabled = ($stock27 <= 0);

                                        $stock28 = $variants[28]['stock_quantity'] ?? 0;
                                        $is28Disabled = ($stock28 <= 0);

                                        // 2. Logic: Auto-select the first available variant
                                        ...
                                        // 3. Set global flags for initial display
                                        $initialStock = ($defaultActiveId == 28) ? $stock28 : $stock27;
                                        $allOutOfStock = ($is27Disabled && $is28Disabled);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 27) ? 'active' : ''; ?> <?php echo $is27Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1199" 
                                            data-variant-id="27" 
                                            data-stock="<?php echo $stock27; ?>"
                                            <?php echo $is27Disabled ? 'disabled' : ''; ?>>
                                        Without Accessories <?php echo $is27Disabled ? '(Sold Out)' : ''; ?>
                                    </button>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 28) ? 'active' : ''; ?> <?php echo $is28Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1299" 
                                            data-variant-id="28" 
                                            data-stock="<?php echo $stock28; ?>"
                                            <?php echo $is28Disabled ? 'disabled' : ''; ?>>
                                        With Accessories <?php echo $is28Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>

                            <div class="p-3 bg-light border rounded mt-4 mb-4">
                                <div class="d-flex align-items-center gap-2">
                                    <i class="bi bi-shield-check" style="font-size: 1.2rem; color:#b30000;"></i>
                                    <span class="fw-bold">Shopping Guarantee</span>
                                </div>
                                <p class="text-muted small mb-0 ms-4">Free & Easy Returns · Merchandise Protection</p>
                            </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 27; ?>">
            ...
            <div class="cart-popup" id="cartPopup">
                    ...
                    <a href="cart.php" id="cartB">View Cart</a>
            </div>

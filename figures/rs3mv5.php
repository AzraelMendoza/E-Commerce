<?php
        ...
        $productId = 440; // 🔁 Change this per product page
        ...
        $initialStock = $variants[85]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/rs3mv5.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/rs3mv5.jpg" checked hidden>
                                    <img src="img/products/rs3mv5.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/rs3mv52.jpg" hidden>
                                    <img src="img/products/rs3mv52.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/rs3m53.jpg" hidden>
                                    <img src="img/products/rs3m53.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 85 and 86
                                            $stock85 = $variants[85]['stock_quantity'] ?? 0;
                                            $is85Disabled = ($stock85 <= 0);

                                            $stock86 = $variants[86]['stock_quantity'] ?? 0;
                                            $is86Disabled = ($stock86 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 86) ? $stock86 : $stock85;
                                            $allOutOfStock = ($is85Disabled && $is86Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 85) ? 'active' : ''; ?> <?php echo $is85Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="450" 
                                                data-variant-id="85" 
                                                data-stock="<?php echo $stock85; ?>"
                                                <?php echo $is85Disabled ? 'disabled' : ''; ?>>
                                            Maglev <?php echo $is85Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 86) ? 'active' : ''; ?> <?php echo $is86Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="850" 
                                                data-variant-id="86" 
                                                data-stock="<?php echo $stock86; ?>"
                                                <?php echo $is86Disabled ? 'disabled' : ''; ?>>
                                            BallCore UV <?php echo $is86Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 85; ?>">

<?php
        ...
        $productId = 422; // 🔁 Change this per product page
        ...
        $initialStock = $variants[53]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Jumanji.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Jumanji.jpg" checked hidden>
                                    <img src="img/products/Jumanji.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/jum2.jpeg" hidden>
                                    <img src="img/products/jum2.jpeg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/jum3.jpg" hidden>
                                    <img src="img/products/jum3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variant 53
                                            $stock53 = $variants[53]['stock_quantity'] ?? 0;
                                            $is53Disabled = ($stock53 <= 0);

                                            // 2. Set initial values for display
                                            $initialStock = $stock53;
                                            $allOutOfStock = $is53Disabled;
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo !$is53Disabled ? 'active' : 'disabled-variant'; ?>" 
                                                data-price="1699" 
                                                data-variant-id="53" 
                                                data-stock="<?php echo $stock53; ?>"
                                                <?php echo $is53Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is53Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="53">

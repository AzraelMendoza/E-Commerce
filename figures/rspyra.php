<?php
        ...
        $productId = 432; // 🔁 Change this per product page
        ...
        $initialStock = $variants[72]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/RSPyra.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/RSPyra.jpg" checked hidden>
                                    <img src="img/products/RSPyra.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/RSPyra2.jpg" hidden>
                                    <img src="img/products/RSPyra2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/rspyra3.jpg" hidden>
                                    <img src="img/products/rspyra3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>

                                 <label>
                                    <input type="radio" name="imgSelect" value="img/products/rsmag.jpeg" hidden>
                                    <img src="img/products/rsmag.jpeg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                        ...
                        <!-- Product Variants -->
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variants 72 and 73
                                                $stock72 = $variants[72]['stock_quantity'] ?? 0;
                                                $is72Disabled = ($stock72 <= 0);

                                                $stock73 = $variants[73]['stock_quantity'] ?? 0;
                                                $is73Disabled = ($stock73 <= 0);

                                                // 2. Logic: Auto-select the first available variant on load
                                                ...
                                                // 3. Set initial values for display
                                                $initialStock = ($defaultActiveId == 73) ? $stock73 : $stock72;
                                                $allOutOfStock = ($is72Disabled && $is73Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 72) ? 'active' : ''; ?> <?php echo $is72Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="299" 
                                                    data-variant-id="72" 
                                                    data-stock="<?php echo $stock72; ?>"
                                                    <?php echo $is72Disabled ? 'disabled' : ''; ?>>
                                                Magnetic <?php echo $is72Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 73) ? 'active' : ''; ?> <?php echo $is73Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="499" 
                                                    data-variant-id="73" 
                                                    data-stock="<?php echo $stock73; ?>"
                                                    <?php echo $is73Disabled ? 'disabled' : ''; ?>>
                                                Maglev <?php echo $is73Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                        ...
                                        <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 72; ?>">

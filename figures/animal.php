<?php
        ...
        $productId = 428; // 🔁 Change this per product page
        ...
        $initialStock = $variants[64]['stock_quantity'] ?? 40;
...
<head>
    ...
    <title>Animal Upon Animal</title>
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/animalUponAnimal.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/animalUponAnimal.PNG" checked hidden>
                                    <img src="img/products/animalUponAnimal.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/animal1.jpg" hidden>
                                    <img src="img/products/animal1.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/animal2.jpg" hidden>
                                    <img src="img/products/animal2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for Variant 64
                                                $stock64 = $variants[64]['stock_quantity'] ?? 0;
                                                $is64Disabled = ($stock64 <= 0);

                                                // 2. Logic: If it's out of stock, we don't want 'active' class 
                                                // but we do want the 'disabled' styling.
                                                $isActive = !$is64Disabled; 
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo $isActive ? 'active' : 'disabled-variant'; ?>" 
                                                    data-price="699" 
                                                    data-variant-id="64" 
                                                    data-stock="<?php echo $stock64; ?>"
                                                    <?php echo $is64Disabled ? 'disabled' : ''; ?>>
                                                Standard <?php echo $is64Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="custom-qty-wrapper">
                                                ...
                                                <input type="number" id="qty" 
                                                    value="<?php echo $is64Disabled ? '0' : '1'; ?>" 
                                                    min="<?php echo $is64Disabled ? '0' : '1'; ?>"> 
                                                <button id="plus" type="button">+</button>
                                            </div>
                                            <span class="text-muted">Stock: <strong id="stockCount"><?php echo $stock64; ?></strong></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="action-buttons mt-4">
                                        <button type="button" 
                                                ...
                                                id="addToCartBtn"
                                                <?php echo $is64Disabled ? 'disabled style="background: gray; cursor: not-allowed;"' : ''; ?>>
                                            Add to Cart
                                        </button>
                                        <button type="button" 
                                                ...
                                                <?php echo $is64Disabled ? 'disabled style="background: #ccc; cursor: not-allowed;"' : ''; ?>>
                                            Buy Now
                                        </button>
                                    </div>
                    </div>
        ...
        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                ...
                <input type="hidden" id="variant_id" name="variant_id" value="64">
                <input type="hidden" id="formQty" name="quantity" value="<?php echo $is64Disabled ? '0' : '1'; ?>">
        </form>

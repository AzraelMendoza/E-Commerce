<?php
        ...
        $productId = 414; // 🔁 Change this per product page
        ...
        $initialStock = $variants[29]['stock_quantity'] ?? 52;
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/Hound.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                <div class="d-flex justify-content-center gap-3 mt-3">
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/Hound.jpg" checked hidden>
                                        <img src="img/products/Hound.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/hound2.jpg" hidden>
                                        <img src="img/products/hound2.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/hound3.jpg" hidden>
                                        <img src="img/products/hound3.jpg" class="thumb">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 29 and 30
                                            $stock29 = $variants[29]['stock_quantity'] ?? 0;
                                            $is29Disabled = ($stock29 <= 0);

                                            $stock30 = $variants[30]['stock_quantity'] ?? 0;
                                            $is30Disabled = ($stock30 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 30) ? $stock30 : $stock29;
                                            $allOutOfStock = ($is29Disabled && $is30Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 29) ? 'active' : ''; ?> <?php echo $is29Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1349" 
                                                data-variant-id="29" 
                                                data-stock="<?php echo $stock29; ?>"
                                                <?php echo $is29Disabled ? 'disabled' : ''; ?>>
                                            Without Accessories <?php echo $is29Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 30) ? 'active' : ''; ?> <?php echo $is30Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1449" 
                                                data-variant-id="30" 
                                                data-stock="<?php echo $stock30; ?>"
                                                <?php echo $is30Disabled ? 'disabled' : ''; ?>>
                                            With Accessories <?php echo $is30Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 29; ?>">

<?php
        ...
        $productId = 406; // 🔁 Change this per product page
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/ironhidee.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                    <div class="d-flex justify-content-center gap-3 mt-3">
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/ironhidee.jpg" checked hidden>
                                            <img src="img/products/ironhidee.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/IR2.jpg" hidden>
                                            <img src="img/products/IR2.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/IR3.jpg" hidden>
                                            <img src="img/products/IR3.jpg" class="thumb">
                                        </label>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variants 13 and 14
                                                $stock13 = $variants[13]['stock_quantity'] ?? 0;
                                                $is13Disabled = ($stock13 <= 0);

                                                $stock14 = $variants[14]['stock_quantity'] ?? 0;
                                                $is14Disabled = ($stock14 <= 0);
                                                ...
                                                $initialStock = ($defaultActiveId == 14) ? $stock14 : $stock13;
                                                $allOutOfStock = ($is13Disabled && $is14Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 13) ? 'active' : ''; ?> <?php echo $is13Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="449" 
                                                    data-variant-id="13" 
                                                    data-stock="<?php echo $stock13; ?>"
                                                    <?php echo $is13Disabled ? 'disabled' : ''; ?>>
                                                Without Accessories <?php echo $is13Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 14) ? 'active' : ''; ?> <?php echo $is14Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="549" 
                                                    data-variant-id="14" 
                                                    data-stock="<?php echo $stock14; ?>"
                                                    <?php echo $is14Disabled ? 'disabled' : ''; ?>>
                                                With Accessories <?php echo $is14Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                        ...
                                        <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 13; ?>">

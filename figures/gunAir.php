<?php
        ...
        $productId = 403; // 🔁 Change this per product page
        ...
        $initialStock = $variants[7]['stock_quantity'] ?? 0;
                    ...
                    <div class="row g-5">
                            ...
                            <div class="col-lg-5">
                                <div class="sticky-top" style="top: 100px;">
                                    <img id="mainImage" src="img/products/gundamaerial.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                    <div class="d-flex justify-content-center gap-3 mt-3">
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/gundamaerial.PNG" checked hidden>
                                            <img src="img/products/gundamaerial.PNG" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/ga1.PNG" hidden>
                                            <img src="img/products/ga1.PNG" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/ga2.PNG" hidden>
                                            <img src="img/products/ga2.PNG" class="thumb">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7 ps-lg-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variants 7 and 8
                                                $stock7 = $variants[7]['stock_quantity'] ?? 0;
                                                $is7Disabled = ($stock7 <= 0);

                                                $stock8 = $variants[8]['stock_quantity'] ?? 0;
                                                $is8Disabled = ($stock8 <= 0);
                                                ...
                                                $initialStock = ($defaultActiveId == 8) ? $stock8 : $stock7;
                                                $allOutOfStock = ($is7Disabled && $is8Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 7) ? 'active' : ''; ?> <?php echo $is7Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="1249" 
                                                    data-variant-id="7" 
                                                    data-stock="<?php echo $stock7; ?>"
                                                    <?php echo $is7Disabled ? 'disabled' : ''; ?>>
                                                Without Accessories <?php echo $is7Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 8) ? 'active' : ''; ?> <?php echo $is8Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="1349" 
                                                    data-variant-id="8" 
                                                    data-stock="<?php echo $stock8; ?>"
                                                    <?php echo $is8Disabled ? 'disabled' : ''; ?>>
                                                With Accessories <?php echo $is8Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                        ...
                                        <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 7; ?>">

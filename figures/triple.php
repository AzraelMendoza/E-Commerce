<?php
        ...
        $productId = 417; // 🔁 Change this per product page
        ...
        $initialStock = $variants[35]['stock_quantity'] ?? 30;
...
<head>
    ...
    <title>Triple Weighted Chess Pieces</title>
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/triple1.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/triple1.jpg" checked hidden>
                                    <img src="img/products/triple1.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/triple2.jpg" hidden>
                                    <img src="img/products/triple2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/triple4.jpg" hidden>
                                    <img src="img/products/triple4.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            ...
                                            $stock35 = $variants[35]['stock_quantity'] ?? 0;
                                            $is35Disabled = ($stock35 <= 0);

                                            $stock36 = $variants[36]['stock_quantity'] ?? 0;
                                            $is36Disabled = ($stock36 <= 0);

                                            $stock37 = $variants[37]['stock_quantity'] ?? 0;
                                            $is37Disabled = ($stock37 <= 0);
                                            ...
                                            if ($defaultActiveId == 35) $initialStock = $stock35;
                                            elseif ($defaultActiveId == 36) $initialStock = $stock36;
                                            elseif ($defaultActiveId == 37) $initialStock = $stock37;
                                            else $initialStock = 0;

                                            $allOutOfStock = ($is35Disabled && $is36Disabled && $is37Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 35) ? 'active' : ''; ?> <?php echo $is35Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1299" 
                                                data-variant-id="35" 
                                                data-stock="<?php echo $stock35; ?>"
                                                <?php echo $is35Disabled ? 'disabled' : ''; ?>>
                                            Ivory and Black <?php echo $is35Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 36) ? 'active' : ''; ?> <?php echo $is36Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1299" 
                                                data-variant-id="36" 
                                                data-stock="<?php echo $stock36; ?>"
                                                <?php echo $is36Disabled ? 'disabled' : ''; ?>>
                                            Old Natural and Black <?php echo $is36Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 37) ? 'active' : ''; ?> <?php echo $is37Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1399" 
                                                data-variant-id="37" 
                                                data-stock="<?php echo $stock37; ?>"
                                                <?php echo $is37Disabled ? 'disabled' : ''; ?>>
                                            Gold and Silver <?php echo $is37Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 35; ?>">
        ...
        <div class="container mb-5">
            <div class="p-4 border rounded bg-white shadow-sm">
                ...
                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                    <input type="hidden" id="product_id" name="product_id" value="<?php echo $productId; ?>">
                    <input type="hidden" id="variant_id" name="variant_id" value="35">
                    <input type="hidden" id="formQty" name="quantity" value="1">
                </form>

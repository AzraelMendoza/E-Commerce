<?php
        ...
        $productId = 437; // 🔁 Change this per product page
        ...
        $initialStock = $variants[80]['stock_quantity'] ?? 70;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Hanoi.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Hanoi.jpg" checked hidden>
                                    <img src="img/products/Hanoi.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Hanoi2.jpg" hidden>
                                    <img src="img/products/Hanoi2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Hanoi3.jpg" hidden>
                                    <img src="img/products/Hanoi3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variant 80
                                            $stock80 = $variants[80]['stock_quantity'] ?? 0;
                                            $is80Disabled = ($stock80 <= 0);

                                            // 2. Set initial values
                                            $initialStock = $stock80;
                                            $allOutOfStock = $is80Disabled;
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo !$is80Disabled ? 'active' : 'disabled-variant'; ?>" 
                                                data-price="699" 
                                                data-variant-id="80" 
                                                data-stock="<?php echo $stock80; ?>"
                                                <?php echo $is80Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is80Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="80">

<?php
        ...
        $productId = 424; // 🔁 Change this per product page
        ...
        $initialStock = $variants[57]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Clue.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Clue.PNG" checked hidden>
                                    <img src="img/products/Clue.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/clue2.jpg" hidden>
                                    <img src="img/products/clue2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/clue3.jpg" hidden>
                                    <img src="img/products/clue3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // Fetch stock for variants 57 and 58
                                            $stock57 = $variants[57]['stock_quantity'] ?? 0;
                                            $is57Disabled = ($stock57 <= 0);

                                            $stock58 = $variants[58]['stock_quantity'] ?? 0;
                                            $is58Disabled = ($stock58 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 58) ? $stock58 : $stock57;
                                            $allOutOfStock = ($is57Disabled && $is58Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 57) ? 'active' : ''; ?> <?php echo $is57Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="499" 
                                                data-variant-id="57" 
                                                data-stock="<?php echo $stock57; ?>"
                                                <?php echo $is57Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is57Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 58) ? 'active' : ''; ?> <?php echo $is58Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="629" 
                                                data-variant-id="58" 
                                                data-stock="<?php echo $stock58; ?>"
                                                <?php echo $is58Disabled ? 'disabled' : ''; ?>>
                                            Large <?php echo $is58Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 57; ?>">

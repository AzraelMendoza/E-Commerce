<?php
        ...
        $productId = 408; // 🔁 Change this per product page
        ...
        $initialStock = $variants[17]['stock_quantity'] ?? 25;
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-5">
                                <div class="sticky-top" style="top: 100px;">
                                    <img id="mainImage" src="img/products/shock.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                    <div class="d-flex justify-content-center gap-3 mt-3">
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/shock.jpg" checked hidden>
                                            <img src="img/products/shock.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/shock2.jpg" hidden>
                                            <img src="img/products/shock2.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/shock3.jpg" hidden>
                                            <img src="img/products/shock3.jpg" class="thumb">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7 ps-lg-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variants 17 and 18
                                                $stock17 = $variants[17]['stock_quantity'] ?? 0;
                                                $is17Disabled = ($stock17 <= 0);

                                                $stock18 = $variants[18]['stock_quantity'] ?? 0;
                                                $is18Disabled = ($stock18 <= 0);
                                                ...
                                                $initialStock = ($defaultActiveId == 18) ? $stock18 : $stock17;
                                                $allOutOfStock = ($is17Disabled && $is18Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 17) ? 'active' : ''; ?> <?php echo $is17Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="1399" 
                                                    data-variant-id="17" 
                                                    data-stock="<?php echo $stock17; ?>"
                                                    <?php echo $is17Disabled ? 'disabled' : ''; ?>>
                                                Without Accessories <?php echo $is17Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 18) ? 'active' : ''; ?> <?php echo $is18Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="1499" 
                                                    data-variant-id="18" 
                                                    data-stock="<?php echo $stock18; ?>"
                                                    <?php echo $is18Disabled ? 'disabled' : ''; ?>>
                                                With Accessories <?php echo $is18Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                        ...
                                        <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 17; ?>">

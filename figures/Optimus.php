<?php
        ...
        $productId = 407; // 🔁 Change this per product page
        ...
        $initialStock = $variants[15]['stock_quantity'] ?? 25;
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/Optimus.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                <div class="d-flex justify-content-center gap-3 mt-3">
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/Optimus.jpg" checked hidden>
                                        <img src="img/products/Optimus.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/opt1.PNG" hidden>
                                        <img src="img/products/opt1.PNG" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/opt2.PNG" hidden>
                                        <img src="img/products/opt2.PNG" class="thumb">
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 ps-lg-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variants 15 and 16
                                                $stock15 = $variants[15]['stock_quantity'] ?? 0;
                                                $is15Disabled = ($stock15 <= 0);

                                                $stock16 = $variants[16]['stock_quantity'] ?? 0;
                                                $is16Disabled = ($stock16 <= 0);
                                                ...
                                                $initialStock = ($defaultActiveId == 16) ? $stock16 : $stock15;
                                                $allOutOfStock = ($is15Disabled && $is16Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 15) ? 'active' : ''; ?> <?php echo $is15Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="1299" 
                                                    data-variant-id="15" 
                                                    data-stock="<?php echo $stock15; ?>"
                                                    <?php echo $is15Disabled ? 'disabled' : ''; ?>>
                                                Without Accessories <?php echo $is15Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 16) ? 'active' : ''; ?> <?php echo $is16Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="1399" 
                                                    data-variant-id="16" 
                                                    data-stock="<?php echo $stock16; ?>"
                                                    <?php echo $is16Disabled ? 'disabled' : ''; ?>>
                                                With Accessories <?php echo $is16Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                        ...
                                        <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 15; ?>">

<?php
        ...
        $productId = 410; // 🔁 Change this per product page
        ...
        $initialStock = $variants[21]['stock_quantity'] ?? 52;
...
<body>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/grim1.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                <div class="d-flex justify-content-center gap-3 mt-3">
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/grim1.jpg" checked hidden>
                                        <img src="img/products/grim1.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/grim2.jpg" hidden>
                                        <img src="img/products/grim2.jpg" class="thumb">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/grim3.jpg" hidden>
                                        <img src="img/products/grim3.jpg" class="thumb">
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <button type="button" class="btn option-btn active" 
                                                    data-price="1799" 
                                                    data-variant-id="21" 
                                                    data-stock="<?php echo $variants[21]['stock_quantity'] ?? 0; ?>">
                                                Without Accessories
                                            </button>
                                            ...
                                            <button type="button" class="btn option-btn" 
                                                    data-price="1899" 
                                                    data-variant-id="22" 
                                                    data-stock="<?php echo $variants[22]['stock_quantity'] ?? 0; ?>">
                                                With Accessories
                                            </button>
                                        </div>
                            </div>
            ...
            <div class="container mb-5">
                ...
                <form id="cartForm" style="display:none;">
                    <input type="hidden" id="product_id" value="410">
                    <input type="hidden" id="variant_id" value="21">

<?php
        ...
        $productId = 418; // 🔁 Change this per product page
        ...
        $initialStock = $variants[46]['stock_quantity'] ?? 30;
...
<body>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Scrabble.avif" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Scrabble.avif" checked hidden>
                                    <img src="img/products/Scrabble.avif" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/scrab2.jpg" hidden>
                                    <img src="img/products/scrab2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/scrab3.jpg" hidden>
                                    <img src="img/products/scrab3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // 1. Fetch stock for variants 46 and 47
                                                $stock46 = $variants[46]['stock_quantity'] ?? 0;
                                                $is46Disabled = ($stock46 <= 0);

                                                $stock47 = $variants[47]['stock_quantity'] ?? 0;
                                                $is47Disabled = ($stock47 <= 0);

                                                // 2. Logic: Auto-select the first available size on load
                                                ...
                                                $initialStock = ($defaultActiveId == 47) ? $stock47 : $stock46;
                                                $allOutOfStock = ($is46Disabled && $is47Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 46) ? 'active' : ''; ?> <?php echo $is46Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="649" 
                                                    data-variant-id="46" 
                                                    data-stock="<?php echo $stock46; ?>"
                                                    <?php echo $is46Disabled ? 'disabled' : ''; ?>>
                                                Medium <?php echo $is46Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 47) ? 'active' : ''; ?> <?php echo $is47Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="799" 
                                                    data-variant-id="47" 
                                                    data-stock="<?php echo $stock47; ?>"
                                                    <?php echo $is47Disabled ? 'disabled' : ''; ?>>
                                                Large <?php echo $is47Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 46; ?>">
        ...
        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
            <input type="hidden" id="product_id" name="product_id" value="<?php echo $productId; ?>">
            <input type="hidden" id="variant_id" name="variant_id" value="46">

<?php
        ...
        $productId = 415; // 🔁 Change this per product page
        ...
        $initialStock = $variants[31]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Eureka.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Eureka.jpg" checked hidden>
                                    <img src="img/products/Eureka.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/eur2.png" hidden>
                                    <img src="img/products/eur2.png" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/eureka3.jpg" hidden>
                                    <img src="img/products/eureka3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // Fetch stock for variants 31 and 32
                                                $stock31 = $variants[31]['stock_quantity'] ?? 0;
                                                $is31Disabled = ($stock31 <= 0);

                                                $stock32 = $variants[32]['stock_quantity'] ?? 0;
                                                $is32Disabled = ($stock32 <= 0);
                                                ...
                                                $initialStock = ($defaultActiveId == 32) ? $stock32 : $stock31;
                                                $allOutOfStock = ($is31Disabled && $is32Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 31) ? 'active' : ''; ?> <?php echo $is31Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="599" 
                                                    data-variant-id="31" 
                                                    data-stock="<?php echo $stock31; ?>"
                                                    <?php echo $is31Disabled ? 'disabled' : ''; ?>>
                                                Regular Mat <?php echo $is31Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 32) ? 'active' : ''; ?> <?php echo $is32Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="799" 
                                                    data-variant-id="32" 
                                                    data-stock="<?php echo $stock32; ?>"
                                                    <?php echo $is32Disabled ? 'disabled' : ''; ?>>
                                                Mousepad Mat <?php echo $is32Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 31; ?>">

<?php
        ...
        $productId = 400; // 🔁 Change this per product page
        ...
        if (!$product) {
            die("Product not found.");
                ...
                $initialStock = $variants[1]['stock_quantity'] ?? 0;
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-5">
                    <div class="sticky-top" style="top: 100px;">
                        <img id="mainImage" src="img/products/bee.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                        <div class="d-flex justify-content-center gap-3 mt-3">
                            <label>
                                <input type="radio" name="imgSelect" value="img/products/bee.jpg" checked hidden>
                                <img src="img/products/bee.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                            </label>
                            <label>
                                <input type="radio" name="imgSelect" value="img/products/bee2.jpg" hidden>
                                <img src="img/products/bee2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                            </label>
                            <label>
                                <input type="radio" name="imgSelect" value="img/products/bee3.jpg" hidden>
                                <img src="img/products/bee3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // Fetch stock for variants 1 and 2
                                        $stock1 = $variants[1]['stock_quantity'] ?? 0;
                                        $is1Disabled = ($stock1 <= 0);

                                        $stock2 = $variants[2]['stock_quantity'] ?? 0;
                                        $is2Disabled = ($stock2 <= 0);

                                        // Logic to select the first available variant on load
                                        ...
                                        $initialStock = ($defaultActiveId == 2) ? $stock2 : $stock1;
                                        $allOutOfStock = ($is1Disabled && $is2Disabled);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 1) ? 'active' : ''; ?> <?php echo $is1Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1199" 
                                            data-variant-id="1" 
                                            data-stock="<?php echo $stock1; ?>"
                                            <?php echo $is1Disabled ? 'disabled' : ''; ?>>
                                        Without Accessories <?php echo $is1Disabled ? '(Sold Out)' : ''; ?>
                                    </button>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 2) ? 'active' : ''; ?> <?php echo $is2Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1299" 
                                            data-variant-id="2" 
                                            data-stock="<?php echo $stock2; ?>"
                                            <?php echo $is2Disabled ? 'disabled' : ''; ?>>
                                        With Accessories <?php echo $is2Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                        </div>
                        ...
                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                            ...
                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 1; ?>">

  <?php
        ...
        $productId = 460; // 🔁 Change this per product page
        ...
        $initialStock = $variants[138]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/porche.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/porche.jpg" checked hidden>
                                    <img src="img/products/porche.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/porche2.jpg" hidden>
                                    <img src="img/products/porche2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/porche3.jpg" hidden>
                                    <img src="img/products/porche3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // 1. Define the variants based on your requirements
                                        $product_variants = [
                                            138 => ['color' => 'Gray', 'price' => 1999],
                                            139 => ['color' => 'White', 'price' => 1099],
                                            140 => ['color' => 'Olive Green', 'price' => 1149]
                                        ];
                                        ...
                                        foreach ($product_variants as $id => $data): 
                                            $stock = $variants[$id]['stock_quantity'] ?? 0;
                                            $isDisabled = ($stock <= 0);
                                            
                                            // Track if at least one item is in stock
                                            if (!$isDisabled) { $allOutOfStock = false; }
                                            
                                            // Set initial stock display for the first active variant
                                            if ($firstIteration) { $initialStock = $stock; }
                                    ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($firstIteration && !$isDisabled) ? 'active' : ''; ?> <?php echo $isDisabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $data['price']; ?>" 
                                                data-variant-id="<?php echo $id; ?>" 
                                                data-stock="<?php echo $stock; ?>"
                                                <?php echo $isDisabled ? 'disabled' : ''; ?>>
                                            <?php echo $data['color']; ?> <?php echo $isDisabled ? '(Sold Out)' : ''; ?>
                                        </button>

<?php
        ...
        $productId = 438; // 🔁 Change this per product page
        ...
        $initialStock = $variants[81]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/ganxs.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/ganxs.jpg" checked hidden>
                                    <img src="img/products/ganxs.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/ganxs1.jpg" hidden>
                                    <img src="img/products/ganxs1.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/ganxs2.jpg" hidden>
                                    <img src="img/products/ganxs2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                                ...
                                <div class="mt-4">
                                        ...
                                        <div class="d-flex gap-2">
                                            <?php 
                                                // Fetch stock for variants 81 and 82
                                                $stock81 = $variants[81]['stock_quantity'] ?? 0;
                                                $is81Disabled = ($stock81 <= 0);

                                                $stock82 = $variants[82]['stock_quantity'] ?? 0;
                                                $is82Disabled = ($stock82 <= 0);

                                                // Logic: Find the first available variant to set as default active
                                                ...
                                                $initialStock = ($defaultActiveId == 82) ? $stock82 : $stock81;
                                                $allOutOfStock = ($is81Disabled && $is82Disabled);
                                            ?>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 81) ? 'active' : ''; ?> <?php echo $is81Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="899" 
                                                    data-variant-id="81" 
                                                    data-stock="<?php echo $stock81; ?>"
                                                    <?php echo $is81Disabled ? 'disabled' : ''; ?>>
                                                Stickerless <?php echo $is81Disabled ? '(Sold Out)' : ''; ?>
                                            </button>

                                            <button type="button" 
                                                    class="btn option-btn <?php echo ($defaultActiveId == 82) ? 'active' : ''; ?> <?php echo $is82Disabled ? 'disabled-variant' : ''; ?>" 
                                                    data-price="999" 
                                                    data-variant-id="82" 
                                                    data-stock="<?php echo $stock82; ?>"
                                                    <?php echo $is82Disabled ? 'disabled' : ''; ?>>
                                                Stickered <?php echo $is82Disabled ? '(Sold Out)' : ''; ?>
                                            </button>
                                        </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 81; ?>">

<?php
        ...
        $productId = 411; // 🔁 Change this per product page
        ...
        $initialStock = $variants[23]['stock_quantity'] ?? 52;
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-5">
                                <div class="sticky-top" style="top: 100px;">
                                    <img id="mainImage" src="img/products/soundwave.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                    <div class="d-flex justify-content-center gap-3 mt-3">
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/soundwave.jpg" checked hidden>
                                            <img src="img/products/soundwave.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/sound2.PNG" hidden>
                                            <img src="img/products/sound2.PNG" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/sound3.PNG" hidden>
                                            <img src="img/products/sound3.PNG" class="thumb">
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7 ps-lg-5">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="d-flex gap-2">
                                                <?php 
                                                    // 1. Fetch stock for variants 23 and 24
                                                    $stock23 = $variants[23]['stock_quantity'] ?? 0;
                                                    $is23Disabled = ($stock23 <= 0);

                                                    $stock24 = $variants[24]['stock_quantity'] ?? 0;
                                                    $is24Disabled = ($stock24 <= 0);
                                                    ...
                                                    $initialStock = ($defaultActiveId == 24) ? $stock24 : $stock23;
                                                    $allOutOfStock = ($is23Disabled && $is24Disabled);
                                                ?>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo ($defaultActiveId == 23) ? 'active' : ''; ?> <?php echo $is23Disabled ? 'disabled-variant' : ''; ?>" 
                                                        data-price="1249" 
                                                        data-variant-id="23" 
                                                        data-stock="<?php echo $stock23; ?>"
                                                        <?php echo $is23Disabled ? 'disabled' : ''; ?>>
                                                    Without Accessories <?php echo $is23Disabled ? '(Sold Out)' : ''; ?>
                                                </button>

                                                <button type="button" 
                                                        class="btn option-btn <?php echo ($defaultActiveId == 24) ? 'active' : ''; ?> <?php echo $is24Disabled ? 'disabled-variant' : ''; ?>" 
                                                        data-price="1359" 
                                                        data-variant-id="24" 
                                                        data-stock="<?php echo $stock24; ?>"
                                                        <?php echo $is24Disabled ? 'disabled' : ''; ?>>
                                                    With Accessories <?php echo $is24Disabled ? '(Sold Out)' : ''; ?>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                            ...
                                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 23; ?>">

  <?php
        ...
        $productId = 450; // 🔁 Change this per product page
        ...
        $initialStock = $variants[115]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/excavator.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/excavator.jpg" checked hidden>
                                    <img src="img/products/excavator.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/excav2.jpg" hidden>
                                    <img src="img/products/excav2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/excav3.jpg" hidden>
                                    <img src="img/products/excav3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for the single variant 115
                                            $stock115 = $variants[115]['stock_quantity'] ?? 0;
                                            $is115Disabled = ($stock115 <= 0);

                                            // 2. Set values for display
                                            $initialStock = $stock115;
                                            $allOutOfStock = $is115Disabled;
                                            $flatPrice = "1499";
                                            $defaultActiveId = 115;
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn active <?php echo $is115Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="115" 
                                                data-stock="<?php echo $stock115; ?>"
                                                <?php echo $is115Disabled ? 'disabled' : ''; ?>>
                                            Standard Color <?php echo $is115Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>

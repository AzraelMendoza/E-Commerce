<?php
        ...
        $productId = 404; // 🔁 Change this per product page
        ...
        $initialStock = $variants[9]['stock_quantity'] ?? 20;
...
<body>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="sticky-top" style="top: 100px;">
                    <img id="mainImage" src="img/products/mega.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                    <div class="d-flex justify-content-center gap-3 mt-3">
                        <label>
                            <input type="radio" name="imgSelect" value="img/products/mega.PNG" checked hidden>
                            <img src="img/products/mega.PNG" class="thumb">
                        </label>
                        <label>
                            <input type="radio" name="imgSelect" value="img/products/mega2.PNG" hidden>
                            <img src="img/products/mega2.PNG" class="thumb">
                        </label>
                        <label>
                            <input type="radio" name="imgSelect" value="img/products/mega3.PNG" hidden>
                            <img src="img/products/mega3.PNG" class="thumb">
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex gap-2">
                                <?php 
                                    // 1. Fetch stock for variants 9 and 10
                                    $stock9 = $variants[9]['stock_quantity'] ?? 0;
                                    $is9Disabled = ($stock9 <= 0);

                                    $stock10 = $variants[10]['stock_quantity'] ?? 0;
                                    $is10Disabled = ($stock10 <= 0);

                                    // 2. Auto-select logic: Pick the first one that has stock
                                    ...
                                    $initialStock = ($defaultActiveId == 10) ? $stock10 : $stock9;
                                    $allOutOfStock = ($is9Disabled && $is10Disabled);
                                ?>

                                <button type="button" 
                                        class="btn option-btn <?php echo ($defaultActiveId == 9) ? 'active' : ''; ?> <?php echo $is9Disabled ? 'disabled-variant' : ''; ?>" 
                                        data-price="999" 
                                        data-variant-id="9" 
                                        data-stock="<?php echo $stock9; ?>"
                                        <?php echo $is9Disabled ? 'disabled' : ''; ?>>
                                    Without Accessories <?php echo $is9Disabled ? '(Sold Out)' : ''; ?>
                                </button>

                                <button type="button" 
                                        class="btn option-btn <?php echo ($defaultActiveId == 10) ? 'active' : ''; ?> <?php echo $is10Disabled ? 'disabled-variant' : ''; ?>" 
                                        data-price="1099" 
                                        data-variant-id="10" 
                                        data-stock="<?php echo $stock10; ?>"
                                        <?php echo $is10Disabled ? 'disabled' : ''; ?>>
                                    With Accessories <?php echo $is10Disabled ? '(Sold Out)' : ''; ?>
                                </button>
                            </div>
                        </div>
                        ...
                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                            ...
                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 9; ?>">
        ...
        <div class="container mb-5">
            ...
            <form id="cartForm" style="display:none;">
                    <input type="hidden" id="product_id" value="404">
                    <input type="hidden" id="variant_id" value="9">

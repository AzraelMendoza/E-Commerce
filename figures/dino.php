 <?php
        ...
        $productId = 446; // 🔁 Change this per product page
        ...
        $initialStock = $variants[95]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/dino.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/dino.jpg" checked hidden>
                                    <img src="img/products/dino.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/dino2.jpg" hidden>
                                    <img src="img/products/dino2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/dino4.jpg" hidden>
                                    <img src="img/products/dino4.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                  <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variants 95, 96, and 97
                                            $stock95 = $variants[95]['stock_quantity'] ?? 0;
                                            $is95Disabled = ($stock95 <= 0);

                                            $stock96 = $variants[96]['stock_quantity'] ?? 0;
                                            $is96Disabled = ($stock96 <= 0);

                                            $stock97 = $variants[97]['stock_quantity'] ?? 0;
                                            $is97Disabled = ($stock97 <= 0);
                                            ...
                                            if ($defaultActiveId == 95) $initialStock = $stock95;
                                            elseif ($defaultActiveId == 96) $initialStock = $stock96;
                                            elseif ($defaultActiveId == 97) $initialStock = $stock97;
                                            else $initialStock = 0;

                                            $allOutOfStock = ($is95Disabled && $is96Disabled && $is97Disabled);
                                            $flatPrice = "1199";
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 95) ? 'active' : ''; ?> <?php echo $is95Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="95" 
                                                data-stock="<?php echo $stock95; ?>"
                                                <?php echo $is95Disabled ? 'disabled' : ''; ?>>
                                            Red <?php echo $is95Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 96) ? 'active' : ''; ?> <?php echo $is96Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="96" 
                                                data-stock="<?php echo $stock96; ?>"
                                                <?php echo $is96Disabled ? 'disabled' : ''; ?>>
                                            Blue <?php echo $is96Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 97) ? 'active' : ''; ?> <?php echo $is97Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="<?php echo $flatPrice; ?>" 
                                                data-variant-id="97" 
                                                data-stock="<?php echo $stock97; ?>"
                                                <?php echo $is97Disabled ? 'disabled' : ''; ?>>
                                            Black Green <?php echo $is97Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>

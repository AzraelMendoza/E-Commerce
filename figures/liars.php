<?php
        ...
        $productId = 426; // 🔁 Change this per product page
        ...
        $initialStock = $variants[62]['stock_quantity'] ?? 30;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/LiarsDice.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/LiarsDice.PNG" checked hidden>
                                    <img src="img/products/LiarsDice.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/liars2.jpg" hidden>
                                    <img src="img/products/liars2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/liars3.jpg" hidden>
                                    <img src="img/products/liars3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                            ...
                            <div class="mt-4">  
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // 1. Fetch stock for variant 62
                                        $stock62 = $variants[62]['stock_quantity'] ?? 0;
                                        $is62Disabled = ($stock62 <= 0);

                                        // 2. Initial values for UI
                                        $initialStock = $stock62;
                                        $allOutOfStock = $is62Disabled;
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo !$is62Disabled ? 'active' : 'disabled-variant'; ?>" 
                                            data-price="1249" 
                                            data-variant-id="62" 
                                            data-stock="<?php echo $stock62; ?>"
                                            <?php echo $is62Disabled ? 'disabled' : ''; ?>>
                                        Standard <?php echo $is62Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="62">

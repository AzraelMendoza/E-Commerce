<?php
        ...
        $productId = 421; // 🔁 Change this per product page
        ...
        $initialStock = $variants[52]['stock_quantity'] ?? 30;
...
<head>
    ...
    <title>Rummikub Board Game</title>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Rummikub.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Rummikub.PNG" checked hidden>
                                    <img src="img/products/Rummikub.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/rum2.jpg" hidden>
                                    <img src="img/products/rum2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/rum3.jpg" hidden>
                                    <img src="img/products/rum3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // 1. Fetch stock for variant 52
                                            $stock52 = $variants[52]['stock_quantity'] ?? 0;
                                            $is52Disabled = ($stock52 <= 0);

                                            // 2. Set initial values for display
                                            $initialStock = $stock52;
                                            $allOutOfStock = $is52Disabled;
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo !$is52Disabled ? 'active' : 'disabled-variant'; ?>" 
                                                data-price="449" 
                                                data-variant-id="52" 
                                                data-stock="<?php echo $stock52; ?>"
                                                <?php echo $is52Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is52Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="52">

      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0 nav-gap">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
                <li><a class="dropdown-item" href="puzz.php">Puzzles</a></li>
                <li><a class="dropdown-item" href="figures.php">Figures</a></li>
                <li><a class="dropdown-item" href="rc.php">RC Toys</a></li>
                <li><a class="dropdown-item" href="boards.php">Board Games</a></li>
            </ul>
        </li>
      ...
      <div class="ms-lg-auto mt-3 mt-lg-0 d-flex flex-column flex-lg-row align-items-lg-center gap-3">
        ...
        <div class="d-flex align-items-center nav-icons me-3">
          <?php if (isset($_SESSION['user_id'])): ?>
            <a href="dashboard.php" class="icon-btn me-3" title="Profile"><i class="bi bi-person-circle"></i></a>
          <?php else: ?>
            <a href="login.php" class="icon-btn me-3" title="Login"><i class="bi bi-person"></i></a>
          <?php endif; ?>

          <a href="cart.php" class="icon-btn me-3 position-relative">

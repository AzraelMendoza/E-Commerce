<?php
        ...
        $productId = 434; // 🔁 Change this per product page
        ...
        $initialStock = $variants[76]['stock_quantity'] ?? 40;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/Skewb.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/Skewb.PNG" checked hidden>
                                    <img src="img/products/Skewb.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/gansk.jpg" hidden>
                                    <img src="img/products/gansk.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/skewb3.jpg" hidden>
                                    <img src="img/products/skewb3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                        ...
                        <!-- Product Variants -->
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        <?php 
                                            // Fetch stock for variants 76 and 77
                                            $stock76 = $variants[76]['stock_quantity'] ?? 0;
                                            $is76Disabled = ($stock76 <= 0);

                                            $stock77 = $variants[77]['stock_quantity'] ?? 0;
                                            $is77Disabled = ($stock77 <= 0);
                                            ...
                                            $initialStock = ($defaultActiveId == 77) ? $stock77 : $stock76;
                                            $allOutOfStock = ($is76Disabled && $is77Disabled);
                                        ?>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 76) ? 'active' : ''; ?> <?php echo $is76Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="999" 
                                                data-variant-id="76" 
                                                data-stock="<?php echo $stock76; ?>"
                                                <?php echo $is76Disabled ? 'disabled' : ''; ?>>
                                            Standard <?php echo $is76Disabled ? '(Sold Out)' : ''; ?>
                                        </button>

                                        <button type="button" 
                                                class="btn option-btn <?php echo ($defaultActiveId == 77) ? 'active' : ''; ?> <?php echo $is77Disabled ? 'disabled-variant' : ''; ?>" 
                                                data-price="1119" 
                                                data-variant-id="77" 
                                                data-stock="<?php echo $stock77; ?>"
                                                <?php echo $is77Disabled ? 'disabled' : ''; ?>>
                                            Enhanced <?php echo $is77Disabled ? '(Sold Out)' : ''; ?>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                    ...
                                    <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 76; ?>">

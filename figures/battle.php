<?php
        ...
        $productId = 420; // 🔁 Change this per product page
        ...
        $initialStock = $variants[50]['stock_quantity'] ?? 35;
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/battleship.PNG" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/battleship.PNG" checked hidden>
                                    <img src="img/products/battleship.PNG" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/battle2.jpg" hidden>
                                    <img src="img/products/battle2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                                <label>
                                    <input type="radio" name="imgSelect" value="img/products/battle3.jpg" hidden>
                                    <img src="img/products/battle3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 ps-lg-5">
                        ...
                        <div class="mt-3">
                            ...
                            <!-- choosing product variant -->
                            <div class="mt-4">
                                <label class="fw-bold mb-2">Options</label>
                                <div class="d-flex gap-2">
                                    <?php 
                                        // Check stock for both variants
                                        $stock50 = $variants[50]['stock_quantity'] ?? 0;
                                        $is50Disabled = ($stock50 <= 0);

                                        $stock51 = $variants[51]['stock_quantity'] ?? 0;
                                        $is51Disabled = ($stock51 <= 0);

                                        // Logic: Auto-select the first one that actually has stock
                                        $defaultId = null;
                                        if (!$is50Disabled) {
                                            $defaultId = 50;
                                        } elseif (!$is51Disabled) {
                                        ...
                                        // Set initial values for the page load
                                        $initialStock = ($defaultId == 51) ? $stock51 : $stock50;
                                        $initialPrice = ($defaultId == 51) ? "899" : "799";
                                        $allOutOfStock = ($is50Disabled && $is51Disabled);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultId == 50) ? 'active' : ''; ?> <?php echo $is50Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="799" 
                                            data-variant-id="50" 
                                            data-stock="<?php echo $stock50; ?>"
                                            <?php echo $is50Disabled ? 'disabled' : ''; ?>>
                                        Standard <?php echo $is50Disabled ? '(Sold Out)' : ''; ?>
                                    </button>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultId == 51) ? 'active' : ''; ?> <?php echo $is51Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="899" 
                                            data-variant-id="51" 
                                            data-stock="<?php echo $stock51; ?>"
                                            <?php echo $is51Disabled ? 'disabled' : ''; ?>>
                                        Large <?php echo $is51Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>
                                        <!-- product quantity -->
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultId ?: 50; ?>">

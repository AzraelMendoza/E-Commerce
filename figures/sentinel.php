<?php
        ...
        $productId = 401; // 🔁 Change this per product page
        ...
        // FIX: Set default values based on Variant 3 (Sentinel's Without Accessories)
        $initialStock = $variants[3]['stock_quantity'] ?? 52;
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-5">
                        <div class="sticky-top" style="top: 100px;">
                            <img id="mainImage" src="img/products/sentinel1.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                            <div class="d-flex justify-content-center gap-3 mt-3">
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/sentinel1.jpg" checked hidden>
                                            <img src="img/products/sentinel1.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/sentinel2.jpg" hidden>
                                            <img src="img/products/sentinel2.jpg" class="thumb">
                                        </label>
                                        <label>
                                            <input type="radio" name="imgSelect" value="img/products/sentinel3.jpg" hidden>
                                            <img src="img/products/sentinel3.jpg" class="thumb">
                                        </label>
                            </div>
                        </div>
                </div>
                ...
                <div class="col-lg-7 ps-lg-5">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex gap-2">
                                <?php 
                                    ...
                                    $stock3 = $variants[3]['stock_quantity'] ?? 0;
                                    $is3Disabled = ($stock3 <= 0);

                                    $stock4 = $variants[4]['stock_quantity'] ?? 0;
                                    $is4Disabled = ($stock4 <= 0);

                                    // 2. Determine initial active variant (first one with stock)
                                    ...
                                    // 3. Set global flags for UI state
                                    $initialStock = ($defaultActiveId == 4) ? $stock4 : $stock3;
                                    $allOutOfStock = ($is3Disabled && $is4Disabled);
                                ?>

                                <button type="button" 
                                        class="btn option-btn <?php echo ($defaultActiveId == 3) ? 'active' : ''; ?> <?php echo $is3Disabled ? 'disabled-variant' : ''; ?>" 
                                        data-price="1499" 
                                        data-variant-id="3" 
                                        data-stock="<?php echo $stock3; ?>"
                                        <?php echo $is3Disabled ? 'disabled' : ''; ?>>
                                    Without Accessories <?php echo $is3Disabled ? '(Sold Out)' : ''; ?>
                                </button>

                                <button type="button" 
                                        class="btn option-btn <?php echo ($defaultActiveId == 4) ? 'active' : ''; ?> <?php echo $is4Disabled ? 'disabled-variant' : ''; ?>" 
                                        data-price="1599" 
                                        data-variant-id="4" 
                                        data-stock="<?php echo $stock4; ?>"
                                        <?php echo $is4Disabled ? 'disabled' : ''; ?>>
                                    With Accessories <?php echo $is4Disabled ? '(Sold Out)' : ''; ?>
                                </button>
                            </div>
                        </div>
                        ...
                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                            ...
                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 3; ?>">

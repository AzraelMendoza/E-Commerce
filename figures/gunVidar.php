<?php
        ...
        $productId = 405; // 🔁 Change this per product page
        ...
        $initialStock = $variants[1]['stock_quantity'] ?? 20;
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="sticky-top" style="top: 100px;">
                    <img id="mainImage" src="img/products/gv1.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                    <div class="d-flex justify-content-center gap-3 mt-3">
                        <label>
                            <input type="radio" name="imgSelect" value="img/products/gv1.jpg" checked hidden>
                            <img src="img/products/gv1.jpg" class="thumb">
                        </label>
                        <label>
                            <input type="radio" name="imgSelect" value="img/products/gv2.jpg" hidden>
                            <img src="img/products/gv2.jpg" class="thumb">
                        </label>
                        <label>
                            <input type="radio" name="imgSelect" value="img/products/gv3.jpg" hidden>
                            <img src="img/products/gv3.jpg" class="thumb"> 
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 ps-lg-5">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="d-flex gap-2">
                                    <?php 
                                        // 1. Fetch stock for variants 11 and 12
                                        $stock11 = $variants[11]['stock_quantity'] ?? 0;
                                        $is11Disabled = ($stock11 <= 0);

                                        $stock12 = $variants[12]['stock_quantity'] ?? 0;
                                        $is12Disabled = ($stock12 <= 0);
                                        ...
                                        $initialStock = ($defaultActiveId == 12) ? $stock12 : $stock11;
                                        $allOutOfStock = ($is11Disabled && $is12Disabled);
                                    ?>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 11) ? 'active' : ''; ?> <?php echo $is11Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1499" 
                                            data-variant-id="11" 
                                            data-stock="<?php echo $stock11; ?>"
                                            <?php echo $is11Disabled ? 'disabled' : ''; ?>>
                                        Without Accessories <?php echo $is11Disabled ? '(Sold Out)' : ''; ?>
                                    </button>

                                    <button type="button" 
                                            class="btn option-btn <?php echo ($defaultActiveId == 12) ? 'active' : ''; ?> <?php echo $is12Disabled ? 'disabled-variant' : ''; ?>" 
                                            data-price="1599" 
                                            data-variant-id="12" 
                                            data-stock="<?php echo $stock12; ?>"
                                            <?php echo $is12Disabled ? 'disabled' : ''; ?>>
                                        With Accessories <?php echo $is12Disabled ? '(Sold Out)' : ''; ?>
                                    </button>
                                </div>
                            </div>
                            ...
                            <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                                ...
                                <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 11; ?>">

<?php
        ...
        $productId = 416; // 🔁 Change this per product page
        ...
        $initialStock = $variants[33]['stock_quantity'] ?? 30;
...
<head>
    ...
    <title>Wooden Checkers Set</title>
...
<body>
        ...
        <div class="container py-5">
                    <div class="row g-5">
                        ...
                        <div class="col-lg-5">
                            <div class="sticky-top" style="top: 100px;">
                                <img id="mainImage" src="img/products/checkers.jpg" class="product-img shadow-sm mb-3 w-100 rounded" alt="Product Image">

                                <div class="d-flex justify-content-center gap-3 mt-3">
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/checkers.jpg" checked hidden>
                                        <img src="img/products/checkers.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/ch2.jpg" hidden>
                                        <img src="img/products/ch2.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                    </label>
                                    <label>
                                        <input type="radio" name="imgSelect" value="img/products/ch3.jpg" hidden>
                                        <img src="img/products/ch3.jpg" class="thumb" onclick="document.getElementById('mainImage').src=this.src">
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="d-flex gap-2">
                <?php 
                    // 1. Fetch stock for variants 33 and 34
                    $stock33 = $variants[33]['stock_quantity'] ?? 0;
                    $is33Disabled = ($stock33 <= 0);

                    $stock34 = $variants[34]['stock_quantity'] ?? 0;
                    $is34Disabled = ($stock34 <= 0);
                    ...
                    $initialStock = ($defaultActiveId == 34) ? $stock34 : $stock33;
                    $allOutOfStock = ($is33Disabled && $is34Disabled);
                ?>

                <button type="button" 
                        class="btn option-btn <?php echo ($defaultActiveId == 33) ? 'active' : ''; ?> <?php echo $is33Disabled ? 'disabled-variant' : ''; ?>" 
                        data-price="499" 
                        data-variant-id="33" 
                        data-stock="<?php echo $stock33; ?>"
                        <?php echo $is33Disabled ? 'disabled' : ''; ?>>
                    Without Chess Pieces <?php echo $is33Disabled ? '(Sold Out)' : ''; ?>
                </button>

                <button type="button" 
                        class="btn option-btn <?php echo ($defaultActiveId == 34) ? 'active' : ''; ?> <?php echo $is34Disabled ? 'disabled-variant' : ''; ?>" 
                        data-price="619" 
                        data-variant-id="34" 
                        data-stock="<?php echo $stock34; ?>"
                        <?php echo $is34Disabled ? 'disabled' : ''; ?>>
                    With Chess Pieces <?php echo $is34Disabled ? '(Sold Out)' : ''; ?>
                </button>
            </div>
        </div>
                            <div class="mt-4">
                        ...
                        <form id="cartForm" action="buynow.php" method="POST" style="display:none;">
                            ...
                            <input type="hidden" id="variant_id" name="variant_id" value="<?php echo $defaultActiveId ?: 33; ?>">
